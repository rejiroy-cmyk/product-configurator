import { DATA_VERSION, catalog } from './modules/data.js?v=2.6.2';
import { productApps } from './modules/apps.js?v=2.7.9';
import { setupAdmin } from './modules/admin.js?v=2.5.7';
